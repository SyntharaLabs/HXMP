[README.md](https://github.com/user-attachments/files/29750234/README.md)
# HXMP
...
The chain can hold hashes, encrypted chunks, timestamps,# HXMP: Hermes X1 Memory Protocol
...
HXMP is early infrastructure. Treat it as an experimental protocol and tool layer. Review every state-changing action before execution.
 receipts, and identity links. The readable memory stays encrypted. The memory key stays local.
